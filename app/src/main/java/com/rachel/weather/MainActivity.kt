...
import com.rachel.weather.Constants.API_KEY
import com.rachel.weather.Constants.METRIC_UNIT
import com.rachel.weather.models.WeatherResponse
import com.rachel.weather.network.WeatherConfig
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getLocationWeatherDetails(latitude: Double, longitude: Double) {
        if (Constants.isNetworkAvailable(this)) {
            val client = WeatherConfig.Companion.WeatherConfig.getWeatherService()
